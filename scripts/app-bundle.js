...
define('account',["require", "exports", "aurelia-framework", "./web-api"], function (require, exports, aurelia_framework_1, web_api_1) {
    "use strict";
    var Account = (function () {
        function Account(api) {
            this.api = api;
        }
        Account.prototype.configureRouter = function (config, router) {
...
define('agent',["require", "exports"], function (require, exports) {
    "use strict";
    var Agent = (function () {
        function Agent() {
            this.message = "Agent View";
        }
        return Agent;
    }());
    exports.Agent = Agent;
